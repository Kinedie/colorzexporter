...
use ColorzExporter\Service\Export\TeamsCsvExporter;
use Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\Routing\Annotation\Route;

class ExportTeamsCsv extends AbstractController
{
    private TeamsCsvExporter $exporter;

    public function __construct(TeamsCsvExporter $exporter)
    {
        $this->exporter = $exporter;
    }

    #[Route('/teams/csv', name: 'export_teams', methods: 'GET')]
